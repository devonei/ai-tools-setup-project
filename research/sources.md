# Research Sources
Topic: Reddit Marketing for B2B SaaS

## Overview
This project focuses on identifying high-signal experts whose work can help build a practical Reddit marketing playbook for B2B SaaS companies.

I selected experts based on:
- Proven growth marketing experience
- Strong public educational content
- Practical advice over generic theory
- Relevance to community-led growth, audience research, and organic acquisition
...
- Date: 4/16/2026
- Notes: Explains how B2B buyers increasingly rely on Reddit, private communities, and AI tools instead of traditional marketing assets. Introduces the "Listen → Learn → Leap" framework for Reddit marketing and positions Reddit as a trust and discovery layer in modern SaaS buying journeys.

---

## Amanda Natividad
Role: VP of Marketing at SparkToro, creator of Zero Click Marketing, and leading voice on modern search behavior, audience research, and community-led brand discovery.

Why Relevant:
Her work explains why Reddit increasingly matters in B2B SaaS buyer journeys, brand perception, hidden demand creation, and zero-click influence systems.
